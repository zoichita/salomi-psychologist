...
document.querySelector('[data-component="header"]').innerHTML = `
  <header class="site-header"><div class="container nav">
    <a class="brand" href="${base}" aria-label="Σαλώμη Τζιντζιλόγλου, αρχική"><img src="${base}assets/images/logo.png" alt="Λογότυπο Εξέλιξη"><span>Σαλώμη Τζιντζιλόγλου<small>Ψυχολόγος - Συστημική Ψυχοθεραπεία</small></span></a>
