...
document.querySelector('[data-component="header"]').innerHTML = `
  <header class="site-header"><div class="container nav">
    <a class="brand" href="${base}" aria-label="Σαλώμη Τζιντζόγλου, αρχική"><img src="${base}assets/images/logo-clean.png" alt="Λογότυπο Εξέλιξη"><span>Σαλώμη Τζιντζόγλου<small>Ψυχολόγος - Συστημική Ψυχοθεραπεία</small></span></a>
