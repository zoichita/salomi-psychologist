...
const isServices = location.pathname.includes('ypiresies');
...
document.querySelector('[data-component="header"]').innerHTML = `
  ...
  <nav id="main-menu" class="nav__links" aria-label="Κύρια πλοήγηση"><a href="${base}" ${!isServices?'aria-current="page"':''}>Αρχική</a><a href="${base}ypiresies/" ${isServices?'aria-current="page"':''}>Υπηρεσίες</a><a href="#epikoinonia">Επικοινωνία</a><button class="button button--small" type="button" data-open-modal>Κλείστε Ραντεβού</button></nav></div></header>`;
