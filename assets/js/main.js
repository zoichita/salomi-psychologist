...
document.querySelector('[data-component="header"]').innerHTML = `
  <header class="site-header"><div class="container nav"><a class="brand" href="${base}" aria-label="Σαλώμη Τζιντζιλόγλου, αρχική"><img src="${base}assets/images/logo.png" alt="Λογότυπο Εξέλιξη"><span>Σαλώμη Τζιντζιλόγλου<small>Ψυχολόγος</small></span></a>
  <button class="menu-toggle" type="button" aria-label="Άνοιγμα μενού" aria-expanded="false" aria-controls="main-menu">☰</button>
  <nav id="main-menu" class="nav__links" aria-label="Κύρια πλοήγηση"><a href="${base}" ${page==='home'?'aria-current="page"':''}>Αρχική</a><a href="${base}ypiresies/" ${page==='services'?'aria-current="page"':''}>Υπηρεσίες</a><a href="${base}arthra/" ${page==='articles'?'aria-current="page"':''}>Άρθρα</a><a href="#epikoinonia">Επικοινωνία</a><button class="button button--small" type="button" data-open-modal>Κλείστε Ραντεβού</button></nav></div></header>`;

document.querySelector('[data-component="contact"]').innerHTML = `
  <section id="epikoinonia" class="contact" aria-labelledby="contact-title"><div class="container contact__grid"><div class="reveal"><p class="eyebrow">Επικοινωνία</p><h2 id="contact-title">Επικοινωνήστε μαζί μου</h2><p>Για περισσότερες πληροφορίες ή για να προγραμματίσετε το ραντεβού σας, μπορείτε να επικοινωνήσετε τηλεφωνικά ή μέσω email.</p><button class="button" type="button" data-open-modal>Κλείστε Ραντεβού <span aria-hidden="true">→</span></button><div class="contact__details"><div class="contact__detail"><span class="contact__detail-icon" aria-hidden="true">☎</span><div><strong>Τηλέφωνο</strong><a href="tel:+302311545915">2311545915</a></div></div><div class="contact__detail"><span class="contact__detail-icon" aria-hidden="true">✉</span><div><strong>Email</strong><a href="mailto:salomitzinpsy@gmail.com">salomitzinpsy@gmail.com</a></div></div><div class="contact__detail"><span class="contact__detail-icon" aria-hidden="true">⌖</span><div><strong>Διεύθυνση</strong><address>Μ. Αλεξάνδρου 80<br>56224</address></div></div></div></div><div class="map reveal"><iframe title="Χάρτης: Μ. Αλεξάνδρου 80, 56224" src="https://www.google.com/maps?q=Megalou%20Alexandrou%2080%2C%2056224&output=embed" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div></div></section>`;

document.querySelector('.brand small').textContent = 'Ψυχολόγος - Συστημική Ψυχοθεραπεία';

document.querySelector('.contact__details')?.insertAdjacentHTML('beforeend', `<div class="contact__detail"><span class="contact__detail-icon" aria-hidden="true">◎</span><div><strong>Instagram</strong><a href="https://www.instagram.com/exelixi_therapy/?__d=11" target="_blank" rel="noopener noreferrer" aria-label="Instagram Εξέλιξη Therapy (ανοίγει σε νέα καρτέλα)">@exelixi_therapy</a></div></div>`);

document.querySelector('[data-component="footer"]').innerHTML = `
  <footer class="site-footer"><div class="container"><div class="footer__top"><div class="footer__brand">Σαλώμη Τζιντζιλόγλου<span>Ψυχολόγος</span></div><div><p><a href="tel:+302311545915">Τηλέφωνο: 2311545915</a></p><p><a href="mailto:salomitzinpsy@gmail.com">salomitzinpsy@gmail.com</a></p><p>Μ. Αλεξάνδρου 80, 56224</p></div><nav class="footer__links" aria-label="Σύνδεσμοι υποσέλιδου"><a href="${base}">Αρχική</a><a href="${base}ypiresies/">Υπηρεσίες</a><a href="${base}arthra/">Άρθρα</a><a href="#epikoinonia">Επικοινωνία</a></nav></div><div class="footer__bottom">© ${currentYear} Σαλώμη Τζιντζιλόγλου. Με επιφύλαξη παντός δικαιώματος.</div></div></footer>`;
...
const modal = document.querySelector('.modal'); const closeModal = () => { modal.classList.remove('is-open'); modal.setAttribute('aria-hidden','true'); root.style.overflow=''; };
...
document.querySelector('.site-header').addEventListener('transitionend', () => {});
